<template>
    ...
    >
        <div class="time-slider-header h-44 w-full grid grid-cols-3">
            ...
            <span class="my-2.5 text-base range-display justify-self-center"
...
onMounted(() => {
    ...
    props.rInstance.event.on('timeslider/toggle', () => {
